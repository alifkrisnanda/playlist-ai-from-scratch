...
def plot_image(image, boxes): 
    ...
    # Mendapatkan 20 warna berbeda dari peta warna untuk 20 kelas yang berbeda 
...
# Label kelas
class_labels = [
    "pesawat", "sepeda", "burung", "kapal", "botol", "bis", "mobil", "kucing",
    "kursi", "sapi", "meja-makan", "anjing", "kuda", "motor", "orang",
    "tanaman", "kambing", "sofa", "kereta", "tvmonitor"
]
